...
public class Client extends Application {
    ...
    public void addCss(Scene scene){
        ...
        String searchPlayersMenu = this.getClass().getResource("../CSS/SearchPlayersMenu.css").toExternalForm();
        scene.getStylesheets().addAll(application,loginForm,mainMenu,searchPlayersMenu);
    }
