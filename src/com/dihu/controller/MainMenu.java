...
public class MainMenu extends Controller {
    ...
    public MainMenu(){
        ...
        sceneMap.put("SEARCH_PLAYERS","../Scene/SearchPlayersMenu.fxml");
        sceneMap.put("SEARCH_CLUBS","../Scene/SearchClubsMenu.fxml");
        sceneMap.put("ADD_PLAYER","../Scene/AddPlayer.fxml");
