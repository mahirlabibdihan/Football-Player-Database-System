...
public class PlayerDetails extends Controller {
    ...
    public void initialize(){
        ...
        age.setText(Integer.toString(p.getAge())+"  AGE");
        height.setText("HGT  "+Double.toString(p.getHeight()));

        position.setText(p.getPosition().toUpperCase()+"  POS");
        weeklySalary.setText("SAL  "+Double.toString(p.getWeeklySalary()));
