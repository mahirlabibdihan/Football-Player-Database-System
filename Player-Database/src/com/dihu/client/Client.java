...
LOGIN FORM: First of all login form will be shown to the user. There is two options.
...
PLAYERS:    In the players menu all the players of the club will be shown.
            ...
            On clicking a players name, player's card with full details will be shown to the user.

CLUB:       In the club menu there is some info of the club like total yearly salary,country wise player count.
            And password of the club can be changed from here.

TRANSFER:   In the transfer menu users can change the player list of the club by selling/buying.
SELL:       To sell a player user needs to choose from available players in the club and set a price tag for that player(Price must be a valid double number).
            Once the user hit the sell button price will be set in the Player object. The player object will be sent to the server.
